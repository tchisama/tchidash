    ...
    // model : google("gemini-1.5-pro"),
      ...
      dataCollectionTool: {
        ...
        parameters: z.object({
          data: z.array(
            z.object({
              content : z.string().describe("The data to collect , always give data and details about it"),
              type: z.enum(["store", "users", "orders", "products","problems","events","language","other"]).describe("The type of data to collect"),
