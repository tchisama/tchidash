...
export function HeaderStyleForm({ element, onUpdate }: HeaderStyleFormProps) {
  const { style } = element
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        />
        <div className="text-right text-sm text-muted-foreground">{style.fontSize || 24}px</div>
      </div>

      <div className="space-y-2">
        <Label>Font Weight</Label>
        <Select value={style.fontWeight || "bold"} onValueChange={(value) => updateStyle("fontWeight", value)}>
          <SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Slider
          value={[Number.parseFloat(style.lineHeight) || 1.2]}
          min={1}
          max={2}
          step={0.1}
          onValueChange={(value) => updateStyle("lineHeight", value[0].toString())}
        />
        <div className="text-right text-sm text-muted-foreground">{style.lineHeight || 1.2}</div>
      </div>
