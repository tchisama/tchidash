...
import { addDoc, collection, doc, getDocs, increment, query, Timestamp, updateDoc, where } from "firebase/firestore";
...
export default function CreateOrder() {
  ...
  const handleSubmit = async () => {
    ...
    axios.post('/api/orders?storeId=' + storeId, orderForUpdate).then((res) => {
      console.log(res)
    }).catch(() => {
