...
function AskForReviewSettings() {
  const [askForReview, setAskForReview] = React.useState("");
  ...
  useEffect(() => {
    if (store) {
      setAskForReview(store?.AskReviewMessage ?? "");
    }
  }, [store]);
  ...
  return (
    <Card x-chunk="dashboard-04-chunk-1">
      <CardHeader>
        <CardTitle>Ask For Review Message</CardTitle>
        <CardDescription>
          this message will be sent to the customer to ask for review
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="flex mt-4 gap-4">
          <Textarea
            ...
            onChange={(e) => {
              setSaved(false);
              setAskForReview(e.target.value);
            }}
          />
...
export default AskForReviewSettings;
