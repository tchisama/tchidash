      ...
      return (
        ...
        >
          <div className="grid grid-cols-[minmax(auto,8rem)_auto_1fr] items-start px-4">
            ...
            <div className="flex flex-col gap-2 pl-2">
              <TimelineHeader>
                <TimelineTitle className="text-destructive font-medium">{title || 'Error'}</TimelineTitle>
              </TimelineHeader>
...
>(({ className, children, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(' leading-none tracking-tight text-secondary-foreground', className)}
    {...props}
  >
    {children}
  </h3>
