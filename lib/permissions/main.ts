...
export type Role = "super_admin" | "admin" | "order_manager" | "inventory_manager" | "product_manager";
export const ROLES_NAMES = ["super_admin", "admin", "order_manager", "inventory_manager", "product_manager"] as const;
// make me a enum
